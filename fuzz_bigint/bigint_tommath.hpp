...
{
  return impl::unary<IntType, impl::tommath<IntType>::mp_add_one>(arg0);
}

template <typename IntType>
IntType decr(IntType arg0)
{
  return impl::unary<IntType, impl::tommath<IntType>::mp_sub_one>(arg0);
}
...
{
  return impl::unary<IntType, impl::tommath<IntType>::mp_complement>(arg0);
}
