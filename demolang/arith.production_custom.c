...
proto arith_custom_production_FromInteger(struct arith_parse_state * ctx ,token /*INTEGER*/ x1)
{
  (void)ctx;
...
proto arith_custom_production_BinOpPlus(struct arith_parse_state * ctx ,token /*PLUS*/ x1 ,proto /*expr*/ x2 ,proto /*expr*/ x3)
{
  (void)ctx;
  (void)x1;
...
proto arith_custom_production_BinOpMinus(struct arith_parse_state * ctx ,token /*MINUS*/ x1 ,proto /*expr*/ x2 ,proto /*expr*/ x3)
  {
  (void)ctx;
  (void)x1;
...
proto arith_custom_production_BinOpTimes(struct arith_parse_state * ctx ,token /*TIMES*/ x1 ,proto /*expr*/ x2 ,proto /*expr*/ x3)
  {
  (void)ctx;
  (void)x1;
...
proto arith_custom_production_BinOpDivide(struct arith_parse_state * ctx ,token /*DIVIDE*/ x1 ,proto /*expr*/ x2 ,proto /*expr*/ x3)
  {
  (void)ctx;
  (void)x1;
...
proto arith_custom_production_BinOpRemainder(struct arith_parse_state * ctx ,token /*REMAINDER*/ x1 ,proto /*expr*/ x2 ,proto /*expr*/ x3)
  {
  (void)ctx;
  (void)x1;
