...
const char* arith_token_prefix_regexes[arith_token_count] = {
  ...
  [arith_token_ASH] = "(:(:6173)68)",
  [arith_token_LSH] = "(:(:6c73)68)",
  [arith_token_RSH] = "(:(:7273)68)",
  [arith_token_BITNOT] = "(:(:6e6f)74)",
  [arith_token_BITOR] = "(:6f72)",
  [arith_token_BITAND] = "(:(:616e)64)",
  [arith_token_BITXOR] = "(:(:786f)72)",
  [arith_token_CMP] = "(:(:636d)70)",
  ...
  [arith_token_SPACE] = "(:(|(|(|(|200c)0d)09)0b)(*(|(|(|(|200c)0d)09)0b)))",
  [arith_token_NEWLINE] = "(:(*(|(|(|(|(|200c)0a)0d)09)0b))0a)",
