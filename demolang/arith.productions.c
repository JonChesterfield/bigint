...
const char*arith_production_names[arith_production_count] = {
  ...
  [arith_production_custom_production_BinOpAsh] = "custom_production_BinOpAsh",
  [arith_production_custom_production_BinOpLsh] = "custom_production_BinOpLsh",
  [arith_production_custom_production_BinOpRsh] = "custom_production_BinOpRsh",
  [arith_production_custom_production_BinOpBitNot] = "custom_production_BinOpBitNot",
